...
class HomeScreen extends ConsumerWidget {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildNextPrayerCard(context,nextPrayer, zonDesc),
  ...
  Widget _buildNextPrayerCard(BuildContext context,Prayer nextPrayer, String zonDesc) {
    ...
    return Material(
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(24),
        onTap: () {
          context.go('/prayer/${nextPrayer.name}');
        },
        child: Container(
          ...
          child: Padding(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                onTap: () {
                  // Navigasi ke skrin butiran solat
                  context.go('/prayer/${prayer.name}');
                },
